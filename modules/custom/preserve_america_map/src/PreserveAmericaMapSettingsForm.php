...
/**
 * @file
 * Contains \Drupal\preserve_america_map\PreserveAmericaMapSettingsForm
 */
namespace Drupal\preserve_america_map;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

class PreserveAmericaMapSettingsForm extends ConfigFormBase {
  /** 
   * {@inheritdoc}
   */
  public function getFormId () {
    return 'preserve_america_map_admin_settings';
  }
  ...
  public function buildForm (array $form, FormStateInterface $form_state) {
    $config = $this->config ('preserve_america_map.settings');
  ...
  public function submitForm (array &$form, FormStateInterface $form_state) {
    $this->config ('preserve_america_map.settings')
